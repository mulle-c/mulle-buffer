#
# mulle-allocator branch: ${MULLE_ALLOCATOR_NODETYPE:-tar}
#
export MULLE_ALLOCATOR_NODETYPE="git"


#
# mulle-allocator branch: ${MULLE_ALLOCATOR_URL:-https://github.com/mulle-c/mulle-allocator/archive/${MULLE_TAG}.tar.gz}
#
...
#
# mulle-c11 branch: ${MULLE_C11_NODETYPE:-tar}
#
export MULLE_C11_NODETYPE="git"


#
# mulle-c11 branch: ${MULLE_C11_URL:-https://github.com/mulle-c/mulle-c11/archive/${MULLE_TAG}.tar.gz}
#
