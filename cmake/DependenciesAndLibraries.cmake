if( NOT __MULLE_BUFFER_DEPENDENCIES_AND_LIBRARIES_CMAKE__)
   set( __MULLE_BUFFER_DEPENDENCIES_AND_LIBRARIES_CMAKE__ ON)
   ...
   #
   #if( MSVC)
   #   set( MULLE_BUFFER_DEFINITIONS $<|PARENT_IDENTIFIER|>_DEFINITIONS})
   #endif()
endif()
