if( NOT __STANDALONE_C_CMAKE__)
   ...
   if( STANDALONE)
      ...
      if( NOT STANDALONE_NAME)
         set( STANDALONE_NAME "mulle-buffer-standalone")
      endif()
      set( STANDALONE_DEFINITIONS ${MULLE_BUFFER_DEFINITIONS})
...
mulle-buffer-standalone.c with contents like this to it:
   int  ___mulle_buffer_unused__;
and everybody will be happy")
         ...
         add_dependencies( ${STANDALONE_NAME} mulle-buffer)
         if( STARTUP_NAME)
